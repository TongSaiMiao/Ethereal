...
pub const WORKING_DIR: &str = concatcp!(ADB_DIR, "eth/");
pub const BINARY_DIR: &str = concatcp!(WORKING_DIR, "bin/");
pub const ETHEREAL_LOG_FOLDER: &str = concatcp!(WORKING_DIR, "log/");

pub const ETHEREAL_RC_PATH: &str = concatcp!(WORKING_DIR, ".etherealrc");
pub const GLOBAL_NAMESPACE_FILE: &str = concatcp!(ADB_DIR, ".global_namespace_enable");
pub const DAEMON_PATH: &str = concatcp!(ADB_DIR, "ethd");
