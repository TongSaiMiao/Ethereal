package me.ethereal.app.ui.theme
...
import me.ethereal.app.ui.webui.MonetColorsProvider
...
fun EtherealTheme(
    ...
    if (refreshThemeObserver == true) {
        ...
        dynamicColor = prefs.getBoolean("use_system_color_theme", true)
