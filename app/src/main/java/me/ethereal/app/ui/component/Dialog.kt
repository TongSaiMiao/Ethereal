...
import me.ethereal.app.util.ui.EtherealDialogBlurBehindUtils.Companion.setupWindowBlurListener
...
private fun LoadingDialog() {
    Dialog(
        ...
        dialogWindowProvider?.window?.let { setupWindowBlurListener(it) }
    }
}
