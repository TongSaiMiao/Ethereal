package me.ethereal.app.util.ui
...
open class EtherealDialogBlurBehindUtils {
    companion object {
        ...
        private fun getSystemProperty(key: String?): Boolean {
            ...
            try {
                ...
                Log.e("EtherealUI", "[EtherealDialogBlurBehindUtils] Failed to getSystemProperty: ", e)
            }
            return value
        }
                    ...
                    try {
                        ...
                        animator.addUpdateListener { animation: ValueAnimator ->
                            try {
                                ...
                                Log.e(
                                    "EtherealUI",
                                    "[EtherealDialogBlurBehindUtils] Blur behind dialog builder: " + t.toString()
                                )
                            }
                        }
                    } catch (t: Throwable) {
